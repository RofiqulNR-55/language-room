...
<div class="container py-5">
    <div class="text-center mb-5">
        <h2 class="modern-title">Paket Belajar <span class="title-highlight">Online</span></h2>
        <p class="text-muted">Belajar fleksibel dari mana saja dengan paket online kami.</p>
        ...
        @forelse($pakets as $paket)
            <div class="col-md-4 mb-4">
                <div class="card-paket h-100 d-flex flex-column">
                    <div class="paket-icon mb-3"><i class="fas fa-laptop-house"></i></div>
                    <h5 class="fw-bold">{{ $paket->nama }}</h5>
                    <span class="badge bg-success mb-3 align-self-center">{{ $paket->kategori }}</span>
        ...
        @empty
            <div class="col-12">
                <div class="alert alert-warning text-center">
                    Belum ada paket online yang tersedia saat ini.
                </div>
            </div>
        @endforelse
    </div>
